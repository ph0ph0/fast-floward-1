...
function Provider(props) {
  ...
  const destroyCollection = useCallback(
    async () => {
      // TODO (DONE): Implement the destroyCollection.cdc transaction using "fcl.send".
      const transactionId = await fcl
        .send([
          fcl.transaction`
            // Cadence Code
    ...
    async (address) => {
      if (address || state.user.addr) {
        try {
          ...
          // TODO (DONE): Implement the getCollections.cdc script using "fcl.script", and
  ...
  const printPicture = useCallback(
    async (picture) => {
      // TODO (DONE): Implement the print.cdc transcation using "fcl.send".
  ...
  const logIn = () => {
    // TODO (DONE): Implement FCL log in.
    // TODO (DONE): Once implemented, remove the "setUser" call.
    fcl.logIn()
  };
  const logOut = () => {
    // TODO (DONE): Implement FCL log out.
    fcl.unauthenticate()
  };

  useEffect(() => {
    // TODO (DONE): Implement FCL subscription to get current user.
    // TODO (DONE): Once implemented, remove the "setUser" call.
